...
# TODO remove base dir to config
    def save_file(self, file: FileStorage, base_dir: str, additional_path: str) -> str:
    ...
    def delete_file(self, base_dir: str, file_record: FileRecord):
        additional_path = file_record.path
        filename = file_record.get_full_filename()
        filepath = self.get_filepath(base_dir, additional_path, filename)
        os.remove(filepath)

    def update_filename(self, base_dir: str, updated_file_record: FileRecord, new_name: str):
    ...
    def update_file_path(self, base_dir: str, updated_file_record: FileRecord, new_path: str):
        additional_path = updated_file_record.path
    ...
    def get_filepath(self, base_dir: str, additional_path: str, filename: str) -> str:
        # TODO remove
